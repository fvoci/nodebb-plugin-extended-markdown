...
$(document).ready(function () {
  ...
  ExtendedMarkdown.prepareFormattingTools = async function () {
    const [formatting, controls, translator] = await app.require([
      'composer/formatting',
      'composer/controls',
      'translator'
    ])
    if (formatting && controls) {
      ...
      translator.getTranslations(
        window.config.userLang || window.config.defaultLang,
        'extendedmarkdown',
        function (strings) {
          var composerTextarea
          var colorPickerButton = document.querySelector(
            '.btn[data-format="color"]'
          )
          ...
          colorPickerButton.parentNode.insertBefore(
            hiddenPicker,
            colorPickerButton.nextSibling
          )
          hiddenPicker.addEventListener('input', function () {
            ...
            composerTextarea.value =
              composerTextarea.value.slice(0, selectionStart) +
              this.value +
              composerTextarea.value.slice(selectionEnd)
          ...
          formatting.addButtonDispatch(
            ...
            function (textarea, selectionStart, selectionEnd) {
              if (selectionStart === selectionEnd) {
                ...
                var wrapDelta = controls.wrapSelectionInTextareaWith(
                  textarea,
                  '%(#000000)[',
                  ']'
                )
            ...
            function (textarea, selectionStart, selectionEnd) {
              if (selectionStart === selectionEnd) {
                ...
                controls.updateTextareaSelection(
                  textarea,
                  selectionStart + 2,
                  selectionStart + 2 + strings.align_left.length
                )
              } else {
          ...
          formatting.addButtonDispatch(
            ...
            function (textarea, selectionStart, selectionEnd) {
              if (selectionStart === selectionEnd) {
                controls.insertIntoTextarea(
                  textarea,
                  '|-' + strings.align_center + '-|'
                )
                controls.updateTextareaSelection(
                  textarea,
                  selectionStart + 2,
                  selectionStart + 2 + strings.align_center.length
                )
              } else {
                var wrapDelta = controls.wrapSelectionInTextareaWith(
                  textarea,
            ...
            function (textarea, selectionStart, selectionEnd) {
              if (selectionStart === selectionEnd) {
                ...
                controls.updateTextareaSelection(
                  textarea,
                  selectionStart,
                  selectionStart + strings.align_right.length
                )
              } else {
                controls.wrapSelectionInTextareaWith(textarea, '', '-|')
                controls.updateTextareaSelection(
          ...
          formatting.addButtonDispatch(
            ...
            function (textarea, selectionStart, selectionEnd) {
              if (selectionStart === selectionEnd) {
                controls.insertIntoTextarea(
                  textarea,
                  '|=' + strings.align_justify + '=|'
                )
                controls.updateTextareaSelection(
                  textarea,
                  selectionStart + 2,
                  selectionStart + 2 + strings.align_justify.length
                )
              } else {
                controls.wrapSelectionInTextareaWith(textarea, '|=', '=|')
                controls.updateTextareaSelection(
            ...
            function (textarea, selectionStart, selectionEnd) {
              if (selectionStart === selectionEnd) {
                controls.insertIntoTextarea(
                  textarea,
                  '#' +
                    strings.textheader_anchor +
                    '(' +
                    strings.textheader_title +
                    ')'
                )
                controls.updateTextareaSelection(
                  textarea,
                  selectionStart + 1,
                  selectionStart + strings.textheader_anchor.length + 1
                )
              } else {
                var wrapDelta = controls.wrapSelectionInTextareaWith(
                  textarea,
          ...
          formatting.addButtonDispatch(
            ...
            function (textarea, selectionStart, selectionEnd) {
              if (selectionStart === selectionEnd) {
                controls.insertIntoTextarea(
                  textarea,
                  '°fa-info°(' + strings.bubbleinfo_text + ')'
                )
                controls.updateTextareaSelection(
                  textarea,
                  selectionStart + 1,
                ...
                var wrapDelta = controls.wrapSelectionInTextareaWith(
                  textarea,
                  '°',
                  '°(' + strings.bubbleinfo_text + ')'
                )
                controls.updateTextareaSelection(
                  textarea,
                  selectionEnd + 3 - wrapDelta[1],
                  selectionEnd +
                    strings.bubbleinfo_text.length +
                    3 -
                    wrapDelta[1]
                )
              }
            ...
            function (textarea, selectionStart, selectionEnd) {
              if (selectionStart === selectionEnd) {
                ...
                controls.updateTextareaSelection(
                  textarea,
                  selectionStart + 2,
                  selectionStart + 2 + strings.spoiler.length
                )
              } else {
                controls.wrapSelectionInTextareaWith(textarea, '||', '||')
                controls.updateTextareaSelection(
  ...
  async function pageReady() {
    ...
    document
      .querySelectorAll('button.extended-markdown-spoiler')
      .forEach(function (element) {
